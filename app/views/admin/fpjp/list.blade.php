        ...
        <div class="panel-body">
            <div class="tab-content">
                                    ...
                                    <td>
                                      <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                          <li><a href="{{ URL::to('/') }}/admin/fpjp/{{ $fp->id }}/details">Details</a></li>
                                          <li><a href="{{ URL::to('/') }}/admin/fpjp/{{ $fp->id }}/edit">Edit</a></li>
                ...
                <div id="tab-2" class="tab-pane">
                    {{ Form::open(array('url' => 'admin/fpjp' , 'class' => 'form form-horizontal')) }}
                        <div class="col-md-12">
