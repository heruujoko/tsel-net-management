        ...
        <div class="panel-body">
            <div class="tab-content">
                                    ...
                                    <td>
                                      <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                          <li><a href="{{ URL::to('/') }}/admin/versheet/{{ $sheet->id }}/details">Details</a></li>
                                          <li><a href="{{ URL::to('/') }}/admin/versheet/{{ $sheet->id }}/edit">Edit</a></li>
                                          <li><a onclick="popupdelete('{{ $sheet->id }}')">Delete</a></li>
                                        </ul>
                                      </div>
                                    </td>
                                </tr>
                ...
                <div id="tab-2" class="tab-pane">
                    {{ Form::open(array('url' => 'admin/versheet' , 'class' => 'form form-horizontal')) }}
                        <div class="col-md-12">
