        ...
        <div class="panel-body">
            <div class="tab-content">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu">
                                          <li><a href="{{ URL::to('/') }}/admin/activity/{{ $ac->id }}/details">Details</a></li>
                                          <li><a href="{{ URL::to('/') }}/admin/activity/{{ $ac->id }}/edit">Edit</a></li>
                ...
                <div id="tab-2" class="tab-pane">
                    {{ Form::open(array('url' => 'admin/activity' , 'class' => 'form form-horizontal')) }}
                        <div class="col-md-12">
