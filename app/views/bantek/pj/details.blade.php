                        ...
                        <div class="tab-content">
                            ...
                            <div id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    ...
                                    <div class="pull-right">
                                        <div class="">
                                            <a href="/bantek/stpd/{{ $pj->stpd->id }}/print" class="btn btn-primary"><i class="fa fa-print"></i> Print Document</a>
                                        </div>
                                    </div>
                                   <form class="form form-horizontal">
                                        <div class="form-group">
                            ...
                            <div id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                    ...
                                    <div class="pull-right">
                                        <div class="">
                                            <a href="/bantek/versheet/{{ $pj->versheet->id }}/print" class="btn btn-primary"><i class="fa fa-print"></i> Print Document</a>
                                        </div>
                                    </div>
                                   <form class="form form-horizontal">
                                        <div class="form-group">
                            ...
                            <div id="tab-4" class="tab-pane">
                                <div class="panel-body">
                                    ...
                                    <div class="pull-right">
                                        <div class="">
                                            <a href="/bantek/fpjp/{{ $pj->fpjp->id }}/print" class="btn btn-primary"><i class="fa fa-print"></i> Print Document</a>
                                        </div>
                                    </div>
                                   <form class="form form-horizontal">
                                        <div class="form-group">
